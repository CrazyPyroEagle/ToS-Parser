...
namespace NetParse
{
    ...
    public static class ServerMessageParsers
    {
        ...
        public static readonly ParserBuilder<Parser<PlayerID, Parser<bool, ConditionalParser<Parser<string, RootParser>, RootParser>>>, Writer<PlayerID, Writer<bool, ConditionalWriter<Writer<string, RootWriter>, RootWriter>>>> DEATH_NOTE = Parsers.ROOT.After(Converters.STRING).Condition(Parsers.ROOT).After(Converters.BOOLEAN1).After(Converters.Byte<PlayerID>());
        ...
        public static readonly ParserBuilder<Parser<FactionID, Parser<PlayerID, RootParser>>, Writer<FactionID, Writer<PlayerID, RootWriter>>> SPY_NIGHT_ABILITY_MESSAGE = Parsers.ROOT.After(Converters.Byte<PlayerID>()).After(Converters.Byte<FactionID>());
        ...
        public static readonly ParserBuilder<Parser<LocalizationTableID, RootParser>, Writer<LocalizationTableID, RootWriter>> SPY_NIGHT_INFO = Parsers.LOCALIZATION;
        ...
        public static void HowManyPlayersAndGames(this MessageParser parser, uint gameCount, uint playerCount) => parser.Parse((byte)ServerMessageType.HOW_MANY_PLAYERS_AND_GAMES, (buffer, index) => HOW_MANY_PLAYERS_AND_GAMES.Build(buffer, index).Parse(gameCount).Parse(playerCount));
        ...
        public static void DeathNote(this MessageParser parser, PlayerID player, string note) => parser.Parse((byte)ServerMessageType.DEATH_NOTE, (buffer, index) => DEATH_NOTE.Build(buffer, index).Parse(player).Parse(note != null).Parse(note != null, p => p.Parse(note), p => p));
        ...
        public static void SpyNightAbilityMessage(this MessageParser parser, FactionID faction, PlayerID visited) => parser.Parse((byte)ServerMessageType.SPY_NIGHT_ABILITY_MESSAGE, (buffer, index) => SPY_NIGHT_ABILITY_MESSAGE.Build(buffer, index).Parse(faction).Parse(visited));
        ...
        public static void SpyNightInfo(this MessageParser parser, LocalizationTableID message) => parser.Parse((byte)ServerMessageType.SPY_NIGHT_INFO, (buffer, index) => SPY_NIGHT_INFO.Build(buffer, index).Parse(message));
